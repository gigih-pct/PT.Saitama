...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-extrabold text-[#173A67] tracking-tight">Berkas Pendaftaran</h1>
            <p class="text-xs text-gray-500 font-bold uppercase tracking-widest mt-1">Review Berkas Siswa</p>
        </div>
    </div>

    <!-- FILTER BAR -->
    <form method="GET" action="{{ route('admin.berkaspendaftaran') }}" class="bg-white rounded-3xl p-4 shadow-sm border border-gray-100">
    ...
    <div class="space-y-4">
        ...
        <div class="bg-white rounded-3xl p-12 text-center shadow-sm border border-dashed border-gray-200">
            ...
            <h5 class="text-gray-500 font-bold">Belum ada berkas yang diupload.</h5>
            <p class="text-xs text-gray-400 mt-1">Berkas yang diupload siswa akan muncul di sini.</p>
        </div>
        @endforelse
    </div>
