            ...
            <div class="relative group">
                <div class="bg-white/10 backdrop-blur-md rounded-[2.5rem] p-3 border border-white/10 shadow-2xl overflow-hidden">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-[#173A67]/80 to-transparent flex flex-col justify-end p-10">
                        <h4 class="text-xl font-bold mb-2">Portal Admin Saitama</h4>
                        <p class="text-xs text-white/70 font-medium">Manajemen terpusat untuk operasional dan data perusahaan.</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-[#F8FAFC]">
    <div class="w-full max-w-[480px]">
        ...
        <div class="text-center mb-10">
            ...
            <p class="text-slate-400 text-sm font-medium leading-relaxed">Lengkapi formulir di bawah ini untuk mendaftarkan akun Administrator baru.</p>
        </div>
