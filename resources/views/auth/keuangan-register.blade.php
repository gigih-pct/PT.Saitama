<!-- resources/views/auth/keuangan-register.blade.php -->
<!DOCTYPE html>
<html lang="id">
<head>
...
<div class="w-1/2 flex items-center justify-center">
    <div class="w-[420px] text-center">
        ...
        <form method="POST" action="{{ route('keuangan.register.store') }}" class="space-y-4">
            @csrf
        ...
        <p class="mt-6 text-sm">Sudah punya akun? <a href="{{ route('keuangan.login') }}" class="text-blue-600 font-semibold">Login</a></p>
