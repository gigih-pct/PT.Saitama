<!-- resources/views/auth/sensei-login.blade.php -->
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <div class="w-[420px] text-center">
        ...
        <div class="flex justify-center gap-8 mb-6">
            <label class="flex items-center gap-2">
                <input type="radio" name="role" value="sensei" checked class="accent-red-500">
                <span>Sensei</span>
            </label>
            <label class="flex items-center gap-2">
        ...
        <form method="POST" action="{{ route('sensei.login.post') }}" class="space-y-4">
            @csrf
            ...
            <button type="submit" class="mt-4 bg-[#D85B63] hover:bg-[#c44f56] text-white px-10 py-2 rounded-full">
                Masuk
            </button>
        </form>

        <p class="mt-6 text-sm">Belum punya akun? <a href="{{ route('sensei.register') }}" class="text-blue-600 font-semibold">Daftar</a></p>
