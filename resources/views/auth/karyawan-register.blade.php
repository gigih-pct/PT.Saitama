<!-- resources/views/auth/karyawan-register.blade.php -->
<!DOCTYPE html>
<html lang="id">
<head>
    <title>Registrasi Karyawan | PT Saitama Juara Dunia</title>
...
<div class="w-1/2 flex items-center justify-center">
    <div class="w-[420px] text-center">
        ...
        <form method="POST" action="{{ route('karyawan.register.store') }}" class="space-y-4">
            @csrf
            ...
            <div class="flex justify-center gap-8 mb-6">
                <label class="flex items-center gap-2">
                    <input type="radio" name="role" value="guru" {{ old('role', 'guru') == 'guru' ? 'checked' : '' }} class="accent-red-500">
                    <span>Guru</span>
                </label>
                <label class="flex items-center gap-2">
        ...
        <p class="mt-6 text-sm">Sudah punya akun? <a href="{{ route('karyawan.login') }}" class="text-blue-600 font-semibold">Login</a></p>
