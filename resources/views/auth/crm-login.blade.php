<!-- resources/views/auth/crm-login.blade.php -->
<!DOCTYPE html>
<html lang="id">
<head>
...
<div class="w-1/2 flex items-center justify-center">
    <div class="w-[420px] text-center">
        ...
        <form method="POST" action="{{ route('crm.login.post') }}" class="space-y-4">
            @csrf
        ...
        <p class="mt-6 text-sm">Belum punya akun? <a href="{{ route('crm.register') }}" class="text-blue-600 font-semibold">Daftar</a></p>
