...
<head>
    ...
    <title>Login Administrator | PT Saitama Juara Dunia</title>
...
<div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-[#F8FAFC]">
    <div class="w-full max-w-[440px]">
        ...
        <div class="text-center mb-10">
            ...
            <h1 class="text-3xl font-extrabold text-[#173A67] tracking-tight mb-2">Login Administrator</h1>
            <p class="text-slate-400 text-sm font-medium leading-relaxed">Selamat datang kembali! Silakan masuk dengan akun Administrator Anda.</p>
        </div>
        ...
        <div class="mt-12 pt-8 border-t border-gray-100 text-center">
            <p class="text-[13px] font-bold text-slate-400 tracking-tight">
                ...
                <a href="{{ route('admin.register') }}" class="text-[#D85B63] font-extrabold hover:underline ml-1">Daftar Sekarang</a>
            </p>
        </div>
    </div>
</div>
