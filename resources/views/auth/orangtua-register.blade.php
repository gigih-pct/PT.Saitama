            ...
            <div class="relative group">
                <div class="bg-white/10 backdrop-blur-md rounded-[2.5rem] p-3 border border-white/10 shadow-2xl overflow-hidden">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-[#173A67]/80 to-transparent flex flex-col justify-end p-10">
                        <h4 class="text-xl font-bold mb-2">Portal Orang Tua Saitama</h4>
                        <p class="text-xs text-white/70 font-medium">Pantau perkembangan dan prestasi anak Anda secara real-time.</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-[#F8FAFC]">
    <div class="w-full max-w-[480px]">
        ...
        <div class="text-center mb-10">
            ...
            <h1 class="text-3xl font-extrabold text-[#173A67] tracking-tight mb-2">Pendaftaran Orang Tua</h1>
            <p class="text-slate-400 text-sm font-medium leading-relaxed">Lengkapi formulir di bawah ini untuk mendaftarkan akun Orang Tua baru.</p>
        </div>
        ...
        <form method="POST" action="{{ route('orangtua.register.store') }}" class="space-y-5">
            @csrf
        ...
        <div class="mt-12 pt-8 border-t border-gray-100 text-center">
            <p class="text-[13px] font-bold text-slate-400 tracking-tight">
                Sudah punya akun? 
                <a href="{{ route('orangtua.login') }}" class="text-[#D85B63] font-extrabold hover:underline ml-1">Masuk Disini</a>
            </p>
        </div>
    </div>
</div>
