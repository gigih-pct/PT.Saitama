...
<div class="bg-gray-100 min-h-screen rounded-lg p-6 space-y-6 font-sans">
    ...
    <div class="space-y-6">
        ...
        <div class="space-y-4">
            ...
            <!-- ROW 1 -->
            <div class="bg-[#f2f2f2] rounded-full py-4 px-10 flex items-center justify-between shadow-sm hover:bg-gray-200 transition">
                <!-- Label -->
                <div class="w-1/4 font-bold text-[#102a4e] text-lg">Nilai 1</div>
                
                <!-- Center Group -->
                <div class="flex-1 flex items-center justify-center gap-12">
                    <span class="font-bold text-[#102a4e]">Penilaian</span>
                    
                    <!-- Date Pill -->
                    <div class="bg-[#d95d5d] text-white px-6 py-1.5 rounded-full flex items-center gap-3 text-sm font-bold shadow-sm cursor-pointer hover:bg-red-600 transition">
                        <span>17/05/25</span>
            ...
            <!-- ROW 2 -->
            <div class="bg-[#f2f2f2] rounded-full py-4 px-10 flex items-center justify-between shadow-sm hover:bg-gray-200 transition">
                <div class="w-1/4 font-bold text-[#102a4e] text-lg">Nilai 2</div>
            ...
            <!-- ROW 3 -->
            <div class="bg-[#f2f2f2] rounded-full py-4 px-10 flex items-center justify-between shadow-sm hover:bg-gray-200 transition">
                <div class="w-1/4 font-bold text-[#102a4e] text-lg">Nilai 3</div>
            ...
            <!-- ROW 4 -->
            <div class="bg-[#f2f2f2] rounded-full py-4 px-10 flex items-center justify-between shadow-sm hover:bg-gray-200 transition">
                <div class="w-1/4 font-bold text-[#102a4e] text-lg">Nilai 4</div>
