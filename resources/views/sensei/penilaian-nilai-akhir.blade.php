                ...
                <table class="w-max text-left border-collapse">
                    <thead class="bg-[#173A67] text-white sticky top-0 z-20">
                        <tr>
                            ...
                            <th rowspan="2" class="px-6 py-4 font-extrabold text-xs uppercase tracking-widest min-w-[200px] bg-[#173A67] shadow-xl border-r border-blue-800">Nama Siswa</th>
                            ...
                            <th rowspan="2" class="px-4 py-4 font-extrabold text-xs uppercase tracking-widest text-center bg-[#173A67] border-l border-blue-800 shadow-xl">Rata-Rata</th>
                            <th rowspan="2" class="px-4 py-4 font-extrabold text-xs uppercase tracking-widest text-center bg-[#173A67] border-l border-blue-800 w-20">Grade</th>
                        </tr>
                        <tr>
                            @foreach($subjects as $subj)
                    ...
                    <tbody class="divide-y divide-gray-100 bg-white">
                        ...
                        <tr class="group student-row" data-id="{{ $user->id }}" data-row="{{ $idx }}">
                            ...
                            <td class="px-4 py-3 text-center font-black text-[#173A67] bg-white border-l border-gray-100 shadow-[-4px_0_12px_-4px_rgba(0,0,0,0.05)]">
                                <span class="final-avg" data-row="{{ $idx }}">{{ $saved['rata_rata'] ?? '-' }}</span>
                            </td>
                            <td class="px-4 py-3 text-center font-black bg-white border-l border-gray-100 text-white w-20">
